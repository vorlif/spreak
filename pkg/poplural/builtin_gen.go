// This file is generated by poplural/generator/generate.sh; DO NOT EDIT
package poplural
...
func init() {
	...
	registerLanguageForm([]string{"ak", "am", "as", "bho", "bn", "doi", "fa", "fa_AF", "ff", "gu", "guw", "hi", "hy", "kab", "kn", "ln", "mg", "nso", "pa", "pcm", "si", "ti", "wa", "zu"},
		"nplurals=2; plural=n > 1;", &Form{
			NPlurals: 2,
			// nplurals=2; plural=n > 1;
			FormFunc: func(n int64) int {
	...
	registerLanguageForm([]string{"es", "es_419", "es_ES", "es_MX", "it", "pt_PT"},
	...
	registerLanguageForm([]string{"iu", "naq", "sat", "se", "sma", "smi", "smj", "smn", "sms"},
	...
	registerLanguageForm([]string{"mo", "ro", "ro_MD"},
		"nplurals=3; plural=(n == 1) ? 0 : ((n == 0 || n % 100 >= 2 && n % 100 <= 19)) ? 1 : 2;", &Form{
			NPlurals: 3,
	...
	registerLanguageForm([]string{"he"},
		"nplurals=4; plural=(n == 1) ? 0 : (n == 2) ? 1 : (n > 10 && n % 10 == 0) ? 2 : 3;", &Form{
			NPlurals: 4,
	...
	registerLanguageForm([]string{"mt"},
		"nplurals=4; plural=(n == 1) ? 0 : ((n == 0 || n % 100 >= 2 && n % 100 <= 10)) ? 1 : (n % 100 >= 11 && n % 100 <= 19) ? 2 : 3;", &Form{
			NPlurals: 4,
