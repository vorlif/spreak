...
The template extracted by xspreak always uses only the plural categories *one* and *other*.
To create a template with the plural forms suitable for your language, you can use xspreak.
