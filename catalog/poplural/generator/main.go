...
var codeTemplate = template.Must(template.New("rule").Parse(`// This file is generated by poplural/generator/main.go; DO NOT EDIT
package poplural
...
var testTemplate = template.Must(template.New("rule").Parse(`// This file is generated by cldrplural/generator/main.go; DO NOT EDIT
package poplural
	...
	for _, lang := range {{printf "%#v" $data.Languages}} {
		...
		{{range $result, $examples := $data.Examples }}
			for _, example := range {{printf "%#v" $examples}} {
				assert.Equal(t, {{$result}}, form.Evaluate(example), fmt.Sprintf("form.Evaluate(%s) should be {{$result}}", example))
			}
		{{end}}
	}
}
